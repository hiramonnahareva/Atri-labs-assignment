        ...
        <div className='wrapper project-slider'>
            <div className='project-slider w-slider'>
                <div className="project-slider-mask w-slider-mask">
                    <div className="project-slide w-slide" role="group"><div className="w-dyn-list"><div role="list" className="w-dyn-items"><div role="listitem" className="w-dyn-item"><a href="/projects/soulful-rebrand" className="project-slide-link-block w-inline-block">
                        <div className="project-slider-image-wrapper">
                            <img src="https://assets.website-files.com/5ff05a7bd62f16808f485280/6077dc9bcd0f7a437038f60d_image_processing20200129-19798-1k8ponz%201-min.png" loading="lazy" alt="" className="image" />
                        </div>
                        <div className="project-slider-content"><div className="project-slider-tags-wrapper"><div className="project-slider-tag-text-wrapper"><h6 className="project-slider-tag-text">Branding</h6></div></div><div className="project-slider-heading-wrapper">
